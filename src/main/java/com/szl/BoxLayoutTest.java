...
//加入一个 glue, glue 会挤占两个按钮之间的空间
    ...
    public static void main(String[] args) {
        ...
        boxLayoutTest.createTopPanel();
        // 创建 middlePanel
        boxLayoutTest.createMiddlePanel();
        // 创建 bottomPanel
        boxLayoutTest.createBottomPanel();
        ...
        // 加入 topPanel
        panelContainer.add(boxLayoutTest.topPanel,c1);
        ...
        // 加入 middlePanel
        panelContainer.add(boxLayoutTest.middlePanel,c2);
        ...
        // 加入 bottomPanel
        panelContainer.add(boxLayoutTest.bottomPanel,c3);
