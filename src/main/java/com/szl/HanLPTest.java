...
public class HanLPTest {
    public static void main(String args[]) {
        ...
        System.out.println(filter(StandardTokenizer.segment("这样的人才能经受住考验")));
        System.out.println(filter(StandardTokenizer.segment("在这些企业中国有企业有十个")));
        System.out.println(filter(StandardTokenizer.segment("原子结合成分子时")));
        System.out.println(filter(StandardTokenizer.segment("明天下雨")));
        System.out.println(filter(StandardTokenizer.segment("新华社记者兰红光摄")));
        System.out.println(filter(StandardTokenizer.segment("这块地面积还真不小")));
        System.out.println(filter(StandardTokenizer.segment("老师说明天下午休息")));
        System.out.println(filter(StandardTokenizer.segment("他说的确实在理")));
        System.out.println(filter(StandardTokenizer.segment("别把手伸进别人的口袋里")));
        System.out.println(filter(StandardTokenizer.segment("房产的一次性交易流程")));
        System.out.println(filter(StandardTokenizer.segment("在阿里巴巴当HR是怎样一种体验")));
        System.out.println(filter(StandardTokenizer.segment("张飞-知乎")));
        System.out.println(filter(StandardTokenizer.segment("不要不留后路")));
        System.out.println(filter(StandardTokenizer.segment("郑州副局长要火")));
        System.out.println(filter(StandardTokenizer.segment("飞行员年薪有百万吗？")));
        System.out.println(filter(StandardTokenizer.segment("如何才能成为一名优秀的营销策划人")));
        System.out.println(filter(StandardTokenizer.segment("在阿里巴巴当hr是一种怎样的体验")));
        System.out.println(filter(StandardTokenizer.segment(("在阿里工作三个月很想辞职怎么办？"))));
        System.out.println(filter(StandardTokenizer.segment(("《神奇动物在哪里》中有哪些不易察觉的彩蛋或细节？"))));
        System.out.println(filter(StandardTokenizer.segment(("哈利·波特如果当时进了斯莱特林学院会怎么样"))));
        System.out.println(filter(StandardTokenizer.segment(("如何阅读上市公司的年报？有哪些较好的方法？"))));
        System.out.println(filter(StandardTokenizer.segment(("在阿里工作三个月很想辞职怎么办？"))));
...
//        System.out.println(filter(IndexTokenizer.segment("在阿里工作三个月很想辞职怎么办？")));
        ...
        System.out.println(HanLP.extractKeyword(("如何才能成为一名优秀的营销策划人？"), 20));
...
//        System.out.println(NotionalTokenizer.segment("如何才能成为一名优秀的营销策划人"));
//        System.out.println(StandardTokenizer.segment("如何才能成为一名优秀的营销策划人"));
